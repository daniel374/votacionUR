...
const Configs = {
    ...
    appId: '7f1d1eaa-59b3-4ba0-9109-748f7bb1a8f4',
...
class AuthService {
    ...
    logout() {
        localStorage.clear();
        hellojs_dist_hello_all_js__WEBPACK_IMPORTED_MODULE_3__('msft').logout().then(() => { }, e => console.error(e.error.message));
    }
    hasSessiontoken() {
