...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.login = function (callback) {
        hellojs_dist_hello_all_js__WEBPACK_IMPORTED_MODULE_3__('msft').login({ scope: _lib_config__WEBPACK_IMPORTED_MODULE_2__["Configs"].scope }).then(callback, function (e) { return console.error(e.error.message); });
    };
    AuthService.prototype.logout = function () {
        hellojs_dist_hello_all_js__WEBPACK_IMPORTED_MODULE_3__('msft').logout().then(function () {
            localStorage.clear();
        }, function (e) { return console.error(e.error.message); });
    };
    AuthService.prototype.hasSessiontoken = function () {
        var msft = hellojs_dist_hello_all_js__WEBPACK_IMPORTED_MODULE_3__('msft').getAuthResponse();
        if (msft == null) {
            return null;
        }
        else {
...
var DatosComponentService = /** @class */ (function () {
    ...
    DatosComponentService.prototype.guarDatosRepre = function (datosRepresen, vcId) {
        if (vcId != 10) {
    ...
    DatosComponentService.prototype.borrarData = function (arraDrop) {
        //this.resDatos = [];
