...
const ɵ0 = () => __webpack_require__.e(/*! import() | componentes-login-login-module-ngfactory */ "componentes-login-login-module-ngfactory").then(__webpack_require__.bind(null, /*! ./componentes/login/login.module.ngfactory */ "./src/app/componentes/login/login.module.ngfactory.js")).then(mod => mod.LoginModuleNgFactory), ɵ1 = () => Promise.all(/*! import() | componentes-consejos-consejos-module-ngfactory */[__webpack_require__.e("common"), __webpack_require__.e("componentes-consejos-consejos-module-ngfactory")]).then(__webpack_require__.bind(null, /*! ./componentes/consejos/consejos.module.ngfactory */ "./src/app/componentes/consejos/consejos.module.ngfactory.js")).then(mod => mod.ConsejosModuleNgFactory), ɵ2 = () => Promise.all(/*! import() | componentes-formulas-consejo-formulas-consejo-module-ngfactory */[__webpack_require__.e("common"), __webpack_require__.e("componentes-formulas-consejo-formulas-consejo-module-ngfactory")]).then(__webpack_require__.bind(null, /*! ./componentes/formulas-consejo/formulas-consejo.module.ngfactory */ "./src/app/componentes/formulas-consejo/formulas-consejo.module.ngfactory.js")).then(mod => mod.FormulasConsejoModuleNgFactory), ɵ3 = () => Promise.all(/*! import() | componentes-representantes-consejo-representantes-consejo-module-ngfactory */[__webpack_require__.e("common"), __webpack_require__.e("componentes-representantes-consejo-representantes-consejo-module-ngfactory")]).then(__webpack_require__.bind(null, /*! ./componentes/representantes-consejo/representantes-consejo.module.ngfactory */ "./src/app/componentes/representantes-consejo/representantes-consejo.module.ngfactory.js")).then(mod => mod.RepresentantesConsejoModuleNgFactory), ɵ4 = () => Promise.all(/*! import() | componentes-resumen-voto-resumen-voto-module-ngfactory */[__webpack_require__.e("common"), __webpack_require__.e("componentes-resumen-voto-resumen-voto-module-ngfactory")]).then(__webpack_require__.bind(null, /*! ./componentes/resumen-voto/resumen-voto.module.ngfactory */ "./src/app/componentes/resumen-voto/resumen-voto.module.ngfactory.js")).then(mod => mod.ResumenVotoModuleNgFactory);
const routes = [
    {
        path: 'votacion',
        loadChildren: ɵ0
...
class AppComponent {
    constructor(authService, spinner, datosComponentService) {
...
/* harmony import */ var _services_estudiante_service__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./services/estudiante.service */ "./src/app/services/estudiante.service.ts");
/* harmony import */ var _services_consejos_service__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./services/consejos.service */ "./src/app/services/consejos.service.ts");
/* harmony import */ var _services_representantes_service__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./services/representantes.service */ "./src/app/services/representantes.service.ts");
/* harmony import */ var _services_formulas_service__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./services/formulas.service */ "./src/app/services/formulas.service.ts");
/* harmony import */ var _services_datos_component_service__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./services/datos-component.service */ "./src/app/services/datos-component.service.ts");
...
/* harmony import */ var _componentes_navegacion_navegacion_routing_module__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./componentes/navegacion/navegacion-routing.module */ "./src/app/componentes/navegacion/navegacion-routing.module.ts");
/* harmony import */ var _componentes_navegacion_navegacion_module__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ./componentes/navegacion/navegacion.module */ "./src/app/componentes/navegacion/navegacion.module.ts");
/**
 * @fileoverview This file was generated by the Angular template compiler. Do not edit.
 *
 * @suppress {suspiciousCode,uselessCode,missingProperties,missingOverride,checkTypes}
...
class AuthGuard {
    ...
    canActivate(route, state) {
        const currentUser = localStorage.getItem("meToken");
        if (currentUser) {
...
const Configs = {
    ...
    appId: '9a0022d1-1c17-42cd-80e7-0ddf8c97721b',
    scope: 'User.Read',
...
/* harmony import */ var _microsoft_microsoft_graph_client__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @microsoft/microsoft-graph-client */ "./node_modules/@microsoft/microsoft-graph-client/lib/es/index.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
class AuthService {
    constructor(http, httpService, zone, router) {
        this.http = http;
    ...
    initAuth() {
        hellojs_dist_hello_all_js__WEBPACK_IMPORTED_MODULE_3__["init"]({
            msft: {
                id: _lib_config__WEBPACK_IMPORTED_MODULE_2__["Configs"].appId,
                oauth: {
                    version: 2,
    ...
    login(callback) {
        hellojs_dist_hello_all_js__WEBPACK_IMPORTED_MODULE_3__('msft').login({ scope: _lib_config__WEBPACK_IMPORTED_MODULE_2__["Configs"].scope }).then(callback, e => console.error(e.error.message));
    }
    logout() {
        hellojs_dist_hello_all_js__WEBPACK_IMPORTED_MODULE_3__('msft').logout().then(() => {
            localStorage.clear();
        }, e => console.error(e.error.message));
    }
    hasSessiontoken() {
        const msft = hellojs_dist_hello_all_js__WEBPACK_IMPORTED_MODULE_3__('msft').getAuthResponse();
        if (msft == null) {
            return null;
        }
        else {
    ...
    getClient() {
        var client = _microsoft_microsoft_graph_client__WEBPACK_IMPORTED_MODULE_0__["Client"].init({
            authProvider: (done) => {
...
class ConsejosService {
    constructor(http) {
        ...
        this.data_Est = _lib_config__WEBPACK_IMPORTED_MODULE_1__["Configs"].url + '/webadmin/voting/savestudent';
    }
    /* Servicos AWS */
    getConsejos(tpDoc, numDoc, esNom, email, infoPlanes) {
...
ConsejosService.ngInjectableDef = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineInjectable"]({ factory: function ConsejosService_Factory() { return new ConsejosService(_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpClient"])); }, token: ConsejosService, providedIn: "root" });
...
class DatosComponentService {
    ...
    guarDatosRepre(datosRepresen, vcId) {
        if (vcId != 10) {
...
class EstudianteService {
    constructor(http) {
        ...
        this.data_Est = _lib_config__WEBPACK_IMPORTED_MODULE_1__["Configs"].url + '/webadmin/utils/postsoapgeneric';
    }
    dataEstudiante() {
...
EstudianteService.ngInjectableDef = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineInjectable"]({ factory: function EstudianteService_Factory() { return new EstudianteService(_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpClient"])); }, token: EstudianteService, providedIn: "root" });
...
class FormulasService {
    constructor(http) {
        ...
        this.data_Est = _lib_config__WEBPACK_IMPORTED_MODULE_1__["Configs"].url + '/webadmin/generic/gettable';
    }
    /* Servicos AWS */
    formulasConse(vcId, vfSemestre, codPlan) {
        let newToken = localStorage.getItem('newToken');
        console.log("token new " + newToken);
        if (newToken === '') {
        }
...
FormulasService.ngInjectableDef = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineInjectable"]({ factory: function FormulasService_Factory() { return new FormulasService(_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpClient"])); }, token: FormulasService, providedIn: "root" });
...
class HttpService {
    getAccessToken() {
        const msft = hellojs_dist_hello_all_js__WEBPACK_IMPORTED_MODULE_0__('msft').getAuthResponse();
        const accessToken = msft.access_token;
        return accessToken;
    }
}
...
class RepresentantesService {
    ...
    /* service AWS */
    representConse(vcId, vfSemestre, codPlan) {
        let newToken = localStorage.getItem('newToken');
        console.log("token new " + newToken);
        if (newToken === '') {
        }
...
RepresentantesService.ngInjectableDef = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineInjectable"]({ factory: function RepresentantesService_Factory() { return new RepresentantesService(_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpClient"])); }, token: RepresentantesService, providedIn: "root" });
...
module.exports = __webpack_require__(/*! /Users/disenoyproximate/Desktop/Proyectos/ANGULAR/votacionUR/clienteAWS-desa/src/main.ts */"./src/main.ts");
