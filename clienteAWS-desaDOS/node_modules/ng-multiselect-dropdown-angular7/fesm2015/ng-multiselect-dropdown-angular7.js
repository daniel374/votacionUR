import { Component, HostListener, forwardRef, Input, Output, EventEmitter, ChangeDetectionStrategy, ChangeDetectorRef, ViewChild, ElementRef, Directive, Pipe, NgModule } from '@angular/core';
...
class ListFilterPipe {
    ...
    transform(items, filter) {
         ...
         * @return {?}
         */
        (item) => this.applyFilter(item, filter)));
    }
    /**
     * @param {?} item
     * @param {?} filter
